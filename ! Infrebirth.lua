...
pcall(function()getgenv().Theme="THEME HERE"
	hash = "f5c0fd78c1f70ef36f65fd2d8961348e"
	loadstring(game:HttpGet(("https://ghade.net/req.lua"),true))()
	loadstring(game:HttpGet(("https://ghade.net/builds/latest.lua"),true))()
	end)
